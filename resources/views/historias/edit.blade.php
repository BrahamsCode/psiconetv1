...
@section('title', 'Editar Historia Psicológica')

@section('page-title', 'Editar Historia Psicológica')
...
<form action="{{ route('historias.update', $historia) }}" method="POST">
        ...
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="display: flex; align-items: center; gap: 1rem;">
                <span style="color: var(--text-secondary); font-size: 0.9rem;">
                    Historia N°: <strong>{{ $historia->numero_historia }}</strong>
                </span>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1rem;">
            ...
            <div class="form-group">
                ...
                <input type="date" name="fecha_historia" id="fecha_historia"
                    value="{{ old('fecha_historia', $historia->fecha_historia?->format('Y-m-d')) }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="genero" id="genero" required>
                    ...
                    <option value="{{ $key }}" {{ old('genero', $historia->genero) == $key ? 'selected' : '' }}>
                        {{ $value }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="grado_instruccion" id="grado_instruccion">
                    ...
                    <option value="{{ $key }}" {{ old('grado_instruccion', $historia->grado_instruccion) == $key ? 'selected' : '' }}>
                        {{ $value }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="estado_civil" id="estado_civil">
                    ...
                    <option value="{{ $key }}" {{ old('estado_civil', $historia->estado_civil) == $key ? 'selected' : '' }}>
                        {{ $value }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ocupacion" id="ocupacion"
                    value="{{ old('ocupacion', $historia->ocupacion) }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="telefono" id="telefono"
                    value="{{ old('telefono', $historia->telefono) }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="residencia" id="residencia"
                    value="{{ old('residencia', $historia->residencia) }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="religion" id="religion"
                    value="{{ old('religion', $historia->religion) }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="natural_de" id="natural_de"
                    value="{{ old('natural_de', $historia->natural_de) }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="tiempo_residencia_lima" id="tiempo_residencia_lima"
                    value="{{ old('tiempo_residencia_lima', $historia->tiempo_residencia_lima) }}"
                    placeholder="Ej: 10 años, toda la vida">
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1rem;">
            <div class="form-group">
                ...
                <input type="text" name="persona_responsable" id="persona_responsable"
                    value="{{ old('persona_responsable', $historia->persona_responsable) }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="parentesco_responsable" id="parentesco_responsable"
                    value="{{ old('parentesco_responsable', $historia->parentesco_responsable) }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="telefono_responsable" id="telefono_responsable"
                    value="{{ old('telefono_responsable', $historia->telefono_responsable) }}"
                    placeholder="999 999 999">
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 1rem;">
            <div class="form-group">
                ...
                <input type="text" name="asisten_primera_consulta" id="asisten_primera_consulta"
                    value="{{ old('asisten_primera_consulta', $historia->asisten_primera_consulta) }}"
                    placeholder="Nombres de quienes asisten">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="telefono_primera_consulta" id="telefono_primera_consulta"
                    value="{{ old('telefono_primera_consulta', $historia->telefono_primera_consulta) }}"
                    placeholder="999 999 999">
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1rem;">
            <div class="form-group">
                ...
                <input type="text" name="lugar_entrevista" id="lugar_entrevista"
                    value="{{ old('lugar_entrevista', $historia->lugar_entrevista) }}">
            </div>

            <div class="form-group">
                <label for="terapeuta">Terapeuta Asignado</label>
                <input type="text" name="terapeuta" id="terapeuta"
                    value="{{ old('terapeuta', $historia->terapeuta) }}"
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
            <div class="form-group">
                ...
                <select name="recomendado_por" id="recomendado_por" onchange="toggleRecomendadoDetalle()">
                    ...
                    <option value="{{ $key }}" {{ old('recomendado_por', $historia->recomendado_por) == $key ? 'selected' : '' }}>
                        {{ $value }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group" id="recomendado_detalle_group"
                style="display: {{ old('recomendado_por', $historia->recomendado_por) == 'Otros' ? 'block' : 'none' }};">
                <label for="recomendado_detalle">Especificar</label>
                <input type="text" name="recomendado_detalle" id="recomendado_detalle"
                    value="{{ old('recomendado_detalle', $historia->recomendado_detalle) }}"
    ...
    <div style="display: flex; gap: 1rem; justify-content: flex-end;">
        <a href="{{ route('historias.show', $historia) }}" class="btn btn-secondary">
            Cancelar
        </a>
